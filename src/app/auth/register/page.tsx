...
export default function RegisterPage() {
  ...
  return (
    <div className="w-screen min-h-screen flex flex-col bg-gradient-to-br from-blue-50 to-indigo-50 m-0">
      <div className="flex-1 flex flex-col justify-center md:justify-start">
        <div className="w-full flex justify-center">
          <div className="bg-white rounded-2xl shadow-xl w-full p-8 sm:p-16 flex flex-col lg:flex-row min-h-[480px] max-w-6xl mx-auto my-8 lg:my-12 overflow-y-auto" style={{maxHeight: 'calc(100vh - 64px)'}}>
            {/* Left: Form */}

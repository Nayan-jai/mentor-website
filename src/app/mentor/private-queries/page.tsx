          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {queries.map((q) => {
              ...
              return (
                <Card
                  key={q.id}
                  className={`w-full h-full p-4 sm:p-6 rounded-xl hover:shadow-xl transition-shadow duration-200 border-l-4 ${isNew ? "border-green-500 bg-green-50" : "border-pink-400 bg-white"} relative overflow-hidden flex flex-col`}
                >
                  {isNew ? (
                  ...
                  <div className="flex items-center justify-between mb-2">
                    ...
                    >
                      <button className="flex items-center gap-1 px-3 py-1 rounded bg-blue-100 text-blue-700 hover:bg-blue-200 transition-colors text-sm font-medium">
